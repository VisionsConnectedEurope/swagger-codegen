...
public class VisionsConnectedJavaClientCodegen extends DefaultCodegen implements CodegenConfig {
    @SuppressWarnings("hiding")
    private static final Logger LOGGER = LoggerFactory.getLogger(VisionsConnectedJavaClientCodegen.class);
    ...
    protected String artifactId = "swagger-visionsconnected-java-client";
    ...
    public VisionsConnectedJavaClientCodegen() {
        super();
    ...
    public String getName() {
        return "visionsconnected-java";
    }

    @Override
    public String getHelp() {
        return "Generates a Java client library modified for use at VisionsConnected.";
    }
    ...
    public CodegenModel fromModel(String name, Model model, Map<String, Model> allDefinitions) {
        ...
        if (allDefinitions != null && codegenModel != null && codegenModel.parentSchema != null && codegenModel.hasEnums) {
            ...
            codegenModel = VisionsConnectedJavaClientCodegen.reconcileInlineEnums(codegenModel, parentCodegenModel);
        }
